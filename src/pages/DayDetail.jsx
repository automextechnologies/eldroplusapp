    ...
    <div className="min-h-screen bg-surface pb-12">
      ...
      <div className="sticky top-0 z-20 bg-white/90 backdrop-blur-md border-b border-border shadow-sm">
        <div className="max-w-xl mx-auto px-4 py-3.5 flex items-center gap-3">
          ...
          <span
            className={`px-3 py-1.5 rounded-full text-xs font-bold font-mono tracking-wider shadow-sm transition-colors duration-300 ${
              completedCount === 5 ? 'bg-green-100 text-green-700 border border-green-200' : 'bg-brand-50 text-brand-700 border border-brand-100'
            }`}
          >
      ...
      <div className="max-w-xl mx-auto px-4 pt-6 space-y-6">
        ...
        {!isFuture && (
          <div 
            className="rounded-3xl p-6 text-white relative overflow-hidden shadow-lg mb-2"
            style={{ background: 'linear-gradient(135deg, #7A1E04 0%, #C83A0E 55%, #E84C1E 100%)' }}
          >
            <div className="absolute -top-12 -right-12 w-48 h-48 rounded-full bg-white/5 blur-md pointer-events-none" />
            <div className="absolute -bottom-8 -left-8 w-24 h-24 rounded-full bg-black/10 blur-xl pointer-events-none" />
            
            <div className="relative flex justify-between items-center">
              <div>
                <p className="text-white/75 text-xs font-extrabold tracking-widest uppercase">Challenge Day</p>
                <h2 className="font-display font-extrabold text-2xl mt-0.5">Day {dayNumber} Progress</h2>
              </div>
              <div className="w-14 h-14 rounded-2xl bg-white/10 flex items-center justify-center font-bold shadow-inner-sm text-white">
                {completedCount === 5 ? (
            ...
            <div className="relative mt-6 space-y-2">
              ...
              <p className="text-xs text-white/75 font-semibold pt-1">
            ...
            {editableTasks.length > 0 && (
              <div className="space-y-3">
                <div className="flex items-center gap-2 px-1">
                  ...
                  <p className="text-xs font-extrabold text-gray-600 uppercase tracking-widest">Available to Log</p>
                </div>
                <div className="space-y-3">
        ...
        {!isFuture && isPast && (
          <div className="bg-gray-50/50 rounded-2xl p-4 border border-border/60 text-center flex items-center justify-center gap-2">
